    ...
    <div className="aboutProject__container" id="aboutProject">
      ...
      <div className="aboutProject__infoblock">
        ...
        <section className="aboutProject__section" aria-label="Описание сроков выполнения диплома">
          <h3 className="aboutProject__section-subtitle">На выполнение диплома ушло 5 недель</h3>
          ...
          <p className="aboutProject__text_timing aboutProject__text aboutProject__text_removed">Front-end</p>
        </section>
      </div>
